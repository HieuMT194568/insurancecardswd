-- InsuranceCard - SQL Server: bảng + cấu hình (tương đương Flyway V1 + V2).
-- Nếu chạy backend với DB_VENDOR=sqlserver thì Flyway tự chạy phần này, chỉ cần 00_create_database.sql.
USE InsuranceCard;
GO
